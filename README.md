...
This is a project that I developed to learn Svelte and modern component
based web development. You can read my story about it
[here](https://www.dylankatz.xyz/?p=25).
...
Navigate to [localhost:5000](http://localhost:5000). You should see the
app running.
...
package.json's `dependencies` so that the app will work when you deploy
...
so by editing the `"start"` command in package.json:
